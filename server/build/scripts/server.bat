...
set CLASSPATH=%APP_HOME%\lib\KomunreMessanger-server.jar

@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" ru.komunre.Main %CMD_LINE_ARGS%
